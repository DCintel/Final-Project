...
function configureTypeahead(){
    ...
    $("#q").on("typeahead:selected", function(eventObject, suggestion){
        ...
        .done(function(data, textStatus, jqXHR){
            ...
            document.getElementById("game_name").innerHTML = suggestion['name'];
        ...
        $.getJSON("fullscrapeV6.php", parameters)
        .done(function(data, textStatus, jqXHR) {
            console.log(data);
            
            document.getElementById('ign_content').innerHTML = "IGN: " + data[0].ign + " /10";
            
            document.getElementById('gamespot_content').innerHTML = "Gamespot: " + data[0].gamespot + " /10";
            
            document.getElementById('metacritic_content').innerHTML = "Metacritic: " + data[0].metacritic + " /100";
            
            document.getElementById('gamesradar_content').innerHTML = "Games Radar: " + data[0].gamesradar + " /5";
